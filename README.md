...
- **Independence**
  - at **80–99 autonomy**, a subject may **request independence** from its overlord;
  - the overlord may grant or reject that request;
  - at **100 autonomy**, the subject may **peacefully declare independence without approval**;
  - peaceful independence does not automatically make the former subject and overlord hostile;
  ...
  - an independence-war path after a rejected request is intentionally deferred until the fork has a clearer war/casus-belli model.
